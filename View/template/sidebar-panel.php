...
<aside class="panel-sidebar" id="aside">
    ...
    <nav>
        <ul>
            ...
            <li class="items menu<?php if ($activePage == "show-product-list" || $activePage == "add-product" /* and 2 more */) echo " active"; ?>"><a href="javascript:void(0)"><span class="fad fa-store"></span><p>محصولات</p><span class="fas fa-angle-right icon-more"></span></a>
            ...
            <li class="items menu<?php if ($activePage == "") echo " active"; ?>"><a href="javascript:void(0)"><span class="far fa-shield-alt sec"></span><p>امنیت</p><span class="fas fa-angle-right icon-more"></span></a>
                <ul class="more">
