...
<aside class="panel-sidebar" id="aside">
    <ul>
        ...
        <li class="items <?php if (isset($active) && $active == "show-product-list.php") echo "active"; ?>"><a href="<?php echo account("show-product-list.php"); ?>">محصولات</a></li>
        <li class="items <?php if (isset($active) && $active == "add-product.php") echo "active"; ?>"><a href="<?php echo account("add-product.php"); ?>">افزودن آیتم</a></li>
