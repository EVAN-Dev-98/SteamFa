    ...
    <main>
        <form action="<?php echo controller("add-product.php"); ?>" method="post">
            ...
            <section class="mb-3">
                ...
                <select class="form-select" id="game" name="p_type" aria-label="Default select example">
                    <option value="csgo_item" selected>کانتر</option>
                    <option value="dota2_item">دوتا 2</option>
                </select>
            </section>

            <section class="mb-3">
                <label for="csgo_name" class="form-label">نام آیتم : </label>
                <input type="text" class="form-control" id="csgo_name" name="name" placeholder="به عنوان مثال : AWP | Asiimov" required>
            </section>

            <section class="mb-3">
                <label for="csgo_type" class="form-label">نوع : </label>
                <select class="form-select" id="csgo_type" name="type" aria-label="Default select example">
